...
![ExampleImage](img/Rappel%20Events.png)
...
`NPC_E_Rappel_Loop_Cancel`

If you are doing the loop, you need to make the Loop_Cancel as well
...
![RappelContainers](img/RappelContainers.png)
...
Master-Mixer Hierarchy > Default Work Unit > Master Audio Bus > Main > SFX

![Exampleimage](img/Low%20Level%20Output.png)

Select Low_LevelSFX and click OK
...
For the event that's labeled "cancel", it's slightly different. It needs to have the same container you selected for it's similarly named loop, and have the type be "Stop" instead of "Play". You can change it in this field.
