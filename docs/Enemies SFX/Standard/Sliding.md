...
![ExampleImage](img/Slide%20Events.png)
...
![Slidingcontainer](img/SlidingContainer.png)
...
For the event that's labeled "Stop", it's slightly different. It needs to have the same container you selected for it's similarly named Start, and have the type be "Stop" instead of "Play". You can change it in this field.
