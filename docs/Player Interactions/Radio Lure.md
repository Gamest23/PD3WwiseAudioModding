...
[Player Radio Lure.wwu](Downloads/Player%20Radio%20Lure.wwu)
...
![ExampleImage](img/PlayerRadioLureEvents.png)
...
`Radio_Lure_STONK_STOP`

`Radio_Lure_Xmas`

`Radio_Lure_Xmas_STOP`

Each similarly named Event, needs its corresponding STOP Event as well.
...
![RadioContainers](img/RadioLureContainers.png)
