...
[Player Phone.wwu](Downloads/Player%20Phone.wwu)
...
![ExampleImage](img/PlayerPhoneEvents.png)

`Player_Phone_Bring_Up`

`Player_Phone_Equip`

`Player Phone_KB_Click`

Equip and Bring Up appear to do the same, though not sure if either one is not used at some point.
...
![PhoneContainers](img/PhoneContainers.png)
