...
“What are the benefits of replacing audio with Events instead of just using [this](https://modworkshop.net/mod/51045)?”
...
I 100% recommend you add [this tool](https://modworkshop.net/mod/50337) here to your system as well, as it makes packing your mod significantly easier (this guide also uses it within the steps)
