...
[Pager VFX.wwu](Downloads/Pager%20VFX.wwu)
...
Go into the Events tab. The following image of Events[^3^][3] is required to be made, in order to replace the sound properly. You don't have to make every event if you don't want to replace the other VFXs listed. Still, please recreate the image in its folder structure, and naming.

![ExampleImage](img/Pager%20VFX%20Events.png)

`dispatch_alarm`

`dispatch_fooled_1`

`dispatch_fooled_last`

`dispatch_query_sequence`
...
![PagerContainers](img/Pager%20VFX%20Containers.png)
