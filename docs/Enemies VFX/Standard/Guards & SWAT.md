...
Due to how Payday 3 works, Guards and SWAT use the same event, meaning you have to replace both at the same time.
...
[Guards and SWAT Voice Lines.wwu](Downloads/Guard%20and%20SWAT%20Voice%20Lines.wwu)
...
![ExampleImage](img/Voice%20Line%20Guards%20SWAT%20Events.png)
